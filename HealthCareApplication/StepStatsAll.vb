...
Public Class StepStatsAll
    Private Sub SleepStatsAll_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim sqlsteps1day As String = "SELECT [Start],[Activity (steps)] FROM [Xanadu].[dbo].[sleepdata] Order by [Start] Desc"

        Dim adapter As New SqlDataAdapter(sqlsteps1day, connection)
        Dim dataset As New DataSet()
        adapter.Fill(dataset, "StepsAll")
        ...
        chart1.DataSource = dataset.Tables("StepsAll")
