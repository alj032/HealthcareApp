...
Public Class SleepStatsLast
    Private Sub SleepStatsLast_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ''Graph
        ...
        Dim sqlSleepAll As String = "SELECT Top 1 [Start],[Sleep Quality] FROM [Xanadu].[dbo].[sleepdata] Order by [Start] Desc"
        ...
        chart1.Titles.Add("Quality of Sleep for Last Record")
