...
Public Class StepStatsLast
    Private Sub SleepStatsLastDay_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ''Graph
        ...
        adapter.Fill(dataset, "StepsLastDay")
        ...
        chart1.Name = "Number of Steps"
        chart1.Titles.Add("Steps for the Last Day")
        ...
        chart1.DataSource = dataset.Tables("StepsLastDay")
