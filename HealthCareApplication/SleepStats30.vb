...
Public Class SleepStats30

    Private Sub SleepStats30_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ''Graph
        ...
        Dim sqlSleepAll As String = "SELECT Top 30 [Start],[Sleep Quality] FROM [Xanadu].[dbo].[sleepdata] Order by [Start] Desc"
        ...
        chart1.Titles.Add("Quality of Sleep for Last 30 Records")
